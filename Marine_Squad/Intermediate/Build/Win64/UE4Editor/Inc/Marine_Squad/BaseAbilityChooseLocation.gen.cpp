...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseAbilityChooseLocation_Statics::NewProp_WorldPos_MetaData[] = {
		{ "Category", "UnitDeath" },
		{ "ModuleRelativePath", "Abilities/BaseAbilityChooseLocation.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_ABaseAbilityChooseLocation_Statics::NewProp_WorldPos = { "WorldPos", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseAbilityChooseLocation, WorldPos), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_ABaseAbilityChooseLocation_Statics::NewProp_WorldPos_MetaData, ARRAY_COUNT(Z_Construct_UClass_ABaseAbilityChooseLocation_Statics::NewProp_WorldPos_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABaseAbilityChooseLocation_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseAbilityChooseLocation_Statics::NewProp_WorldPos,
	...
	IMPLEMENT_CLASS(ABaseAbilityChooseLocation, 3677957250);
